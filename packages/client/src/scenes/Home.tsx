...
export default class Home extends Component<IProps, IState> {
  ...
  // RENDER
  render() {
    const { drizzle, drizzleState, contractMethodSendWrapper, account, accountValidated, connectAndValidateAccount, route, setRoute, address, connected, web3, networkId} = this.props
